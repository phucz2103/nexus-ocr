...
class ExtractionService:
    ...
    def _persist_page_artifacts(
        ...
        for image_key, image_value in page.images.items():
            # Keep `inputImage` bound to the original upload endpoint instead of
            # the model-emitted preview image so the JSON points back to the
            # exact file the caller submitted.
